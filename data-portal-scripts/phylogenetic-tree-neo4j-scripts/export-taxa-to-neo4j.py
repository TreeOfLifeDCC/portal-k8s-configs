...
with open('taxa-aggs-query.txt', 'r') as file_content:
    aggregationsQuery = file_content.read()
aggregationsResp = requests.post("http://45.86.170.227:31664/data_portal_index/_search?pretty",data=aggregationsQuery, headers=headers).json()
